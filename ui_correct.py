...
class Ui_CorrectDialog(object):
    def setupUi(self, CorrectDialog):
        ...
        self.pushButtonResetRuler = QtWidgets.QPushButton(self.frame)
        self.pushButtonResetRuler.setObjectName("pushButtonResetRuler")
        self.verticalLayout_2.addWidget(self.pushButtonResetRuler)
        self.pushButtonReloadRuler = QtWidgets.QPushButton(self.frame)
        self.pushButtonReloadRuler.setObjectName("pushButtonReloadRuler")
        self.verticalLayout_2.addWidget(self.pushButtonReloadRuler)
    ...
    def retranslateUi(self, CorrectDialog):
        ...
        self.pushButtonResetRuler.setText(_translate("CorrectDialog", "默认规则"))
        self.pushButtonReloadRuler.setText(_translate("CorrectDialog", "应用规则"))
